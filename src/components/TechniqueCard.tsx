  ...
  return (
    <div id={technique.slug} className="scroll-mt-24 rounded-xl border border-white/10 bg-white/5 p-5">
      ...
      <div className="mt-3 rounded-lg border border-white/10 bg-black/30 p-3">
        <p className="text-xs font-semibold uppercase tracking-wide text-foreground/50">Esempio tipico</p>
        <p className="mt-1 text-sm text-foreground/85">{technique.italianExample}</p>
      </div>

      <p className="mt-3 text-sm text-foreground/70">
        <span className="font-semibold text-foreground/85">Perché funziona: </span>
        {technique.whyItWorks}
      </p>
      <p className="mt-2 text-sm text-foreground/70">
        <span className="font-semibold text-foreground/85">Come rispondere: </span>
